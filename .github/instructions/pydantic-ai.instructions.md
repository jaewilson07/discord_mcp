---
applyTo: "src/mcp_ce/agents/**/*.py"
---

below find a sample of a Pydantic AI agent that assists in triaging patient symptoms by integrating with a mock database to fetch patient information and vital signs.

use this design pattern for building agents.
...
use dataclasses to model structures and entities that the agent will interact with.
...
Depenedencies are used to pass contextual information to the agent
...
Output schemas define the structure of the agent's responses.  while Agents use the pydantic-ai library to define behavior, tools, and prompts.
