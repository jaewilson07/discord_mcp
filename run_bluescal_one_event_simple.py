"""Run BluesCal sync workflow to create one Discord event - simplified version."""
...
# Use importlib to avoid triggering __init__.py issues
import importlib.util

# Load evaluator_optimizer directly
spec = importlib.util.spec_from_file_location(
    "evaluator_optimizer",
    os.path.join(os.path.dirname(__file__), "src", "mcp_ce", "agentic_tools", "events", "evaluator_optimizer.py")
)
evaluator_module = importlib.util.module_from_spec(spec)
sys.modules["evaluator_optimizer"] = evaluator_module
...
extract_event_with_quality_control = evaluator_module.extract_event_with_quality_control
